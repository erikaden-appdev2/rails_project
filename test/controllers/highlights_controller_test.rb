...
class HighlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post highlights_url, params: { highlight: { description: @highlight.description, location: @highlight.location, trip_id: @highlight.trip_id } }
    end
  ...
  test "should update highlight" do
    patch highlight_url(@highlight), params: { highlight: { description: @highlight.description, location: @highlight.location, trip_id: @highlight.trip_id } }
